...
V3.0
Папка с ресурсами называется MKS, скопировать целиком в корень SD.
На некоторых экранах этой версии встречается зеркальное отображение экрана, 
в файле variants.h найти и закомментировать строку "#define MKSTFTV3" . Должно получится так "//#define MKSTFTV3".
...
V3.0
The resource folder is called MKS copy the entire folder to the SD root.
 Some screens in this version have a mirror image of the screen, in the file variants.h 
find and comment the "#define MKSTFTV3" string . It should look like this "// #define MKSTFTV3".
