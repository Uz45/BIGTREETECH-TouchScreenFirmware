...
//	case DisplayOrientation::Landscape:Swap XY
      ...
      R60h = (0 << 15) | (0x27 << 8);	// Gate Scan Control (R60h) GS=1(G320) NL[5:0]=0x27 (320 lines)
...
void LCD_RefreshDirection(void)
{
  if(infoSettings.rotate_ui)
  {
    ...
    #endif
    #ifdef MKSTFTV1
//	case DisplayOrientation::Landscape:Swap XY Scan Direction invert mirror X  Rotate 180 degress
   	   uint16_t R01h, R03h, R60h;
