#ifndef _PIN_MKS_TFT32_V1_1_H_ // modify to actual filename !!!
#define _PIN_MKS_TFT32_V1_1_H_ // modify to actual filename !!!
...
// LCD interface
  ...
  #define TFTLCD_DRIVER MKSTFTV1  // Type of LCD driver, now support[RM68042, ILI9488, ILI9341, ST7789, HX8558].
...
//#define DISABLE_DEBUG // free all pins
   #if (defined(LCD_ENCA_PIN) && defined(LCD_ENCB_PIN) && defined(LCD_BTN_PIN))
