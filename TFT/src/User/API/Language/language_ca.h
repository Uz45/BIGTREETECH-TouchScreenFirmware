...
#define _LANGUAGE_CA_H_
    ...
    #define STRING_BLTOUCH_TEST           "Provar"
    #define STRING_BLTOUCH_DEPLOY         "Desplegar"
    #define STRING_BLTOUCH_STOW           "Plegar"
    ...
    #define STRING_FILAMENT_SENSOR        "Sensor de filament"
    ...
    #define STRING_INVERT_XAXIS           "Invertir eix X"
    #define STRING_INVERT_YAXIS           "Invertir eix Y"
    #define STRING_INVERT_ZAXIS           "Invertir eix Z"
    #define STRING_MOVE_SPEED             "Velocitat de moviment(X Y Z)"
    #define STRING_KNOB_LED               "Perilla rotativa LED"
    #define STRING_KNOB_LED_IDLE          "Rotary Knob LED idle"
    #define STRING_M0_PAUSE               "En pausa per l'ordre M0"
    #define STRING_SEND_START_GCODE       "Enviar Gcode inicial"
    #define STRING_SEND_END_GCODE         "Enviar Gcode final"
    #define STRING_SEND_CANCEL_GCODE      "Cancel · lar Gcode"
    #define STRING_PERSISTENT_STATUS_INFO "Informació d'estat persistent"
    #define STRING_FILE_LISTMODE          "Mode de visualització de fitxers"
    ...
    #define STRING_RESET_SETTINGS_INFO    "Restableix tota la configuració a\nvalors predeterminats?"
    #define STRING_RESET_SETTINGS_DONE    "Restableix tota la configuració\naconseguit.\nreinicieu el dispositiu."
    #define STRING_INFO                   "Informació"
    #define STRING_LCD_BRIGHTNESS         "Lluminositat LCD"
    #define STRING_LCD_BRIGHTNESS_DIM     "Dim Lluminositat LCD"
    #define STRING_LCD_DIM_IDLE_TIMER     "Temporitzador inactiu LCD"
    ...
    #define STRING_ST7920_FULLSCREEN      "Mode Marlin a pantalla completa"
    #define STRING_PLR_EN                 "Recuperació de pèrdua d’energia"
    #define STRING_SETTING_SAVE           "Save settings"
    #define STRING_SETTING_RESET          "Restableix la configuració"
    #define STRING_SETTING_RESTORE        "Restaura la configuració"
