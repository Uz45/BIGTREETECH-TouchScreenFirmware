...
#define _LANGUAGE_TC_H_
    ...
    #define STRING_BLTOUCH_TEST           "BLTouch檢測"
    #define STRING_BLTOUCH_DEPLOY         "探針彈出"
    #define STRING_BLTOUCH_STOW           "探針收回"
    ...
    #define STRING_SIMULATOR_BG_COLOR     "Marlin模式背景顏色"
    #define STRING_SIMULATOR_FONT_COLOR   "Marlin模式字體顏色"
    ...
    #define STRING_FILAMENT_SENSOR        "耗材感應器"
    ...
    #define STRING_AUTO_SHUT_DOWN         "自動關機"
    ...
    #define STRING_INVERT_XAXIS           "X軸反向運轉"
    #define STRING_INVERT_YAXIS           "Y軸反向運轉"
    #define STRING_INVERT_ZAXIS           "Z軸反向運轉"
    #define STRING_MOVE_SPEED             "移動速度(X Y Z)"
    #define STRING_KNOB_LED               "旋鈕LED顏色"
    #define STRING_KNOB_LED_IDLE          "旋鈕LED自動睡眠"
    #define STRING_M0_PAUSE               "M0暫停"
    #define STRING_SEND_START_GCODE       "執行起始G-code"
    #define STRING_SEND_END_GCODE         "執行結尾G-code"
    #define STRING_SEND_CANCEL_GCODE      "中斷執行G-code"
    #define STRING_PERSISTENT_STATUS_INFO "頂部溫度訊息"
    #define STRING_FILE_LISTMODE          "文件預覽列表模式"
    ...
    #define STRING_RESET_SETTINGS_INFO    "所有設定都會恢復預設值，確定嗎?"
    #define STRING_RESET_SETTINGS_DONE    "重設成功，請重新開機"
    #define STRING_INFO                   "提示" //Info Sign
    #define STRING_LCD_BRIGHTNESS         "螢幕亮度"
    #define STRING_LCD_BRIGHTNESS_DIM     "睡眠狀態螢幕亮度"
    #define STRING_LCD_DIM_IDLE_TIMER     "螢幕進入睡眠時間"
    ...
    #define STRING_CUSTOM_SECONDS         "自訂"
    #define STRING_ST7920_FULLSCREEN      "全螢幕Marlin模式"
