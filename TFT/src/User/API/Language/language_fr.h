...
#define _LANGUAGE_FR_H_
    ...
    #define STRING_DEFAULT_MODE           "Mode par défaut"
    ...
    #define STRING_ONBOARD_SD_SUPPORT     "Support SD interne"
    #define STRING_M27_ALWAYS_ACTIVE      "M27 toujours actif"
    #define STRING_LONG_FILENAME_SUPPORT  "Noms de fichiers longs"
    ...
    #define STRING_PS_ON_ACTIVE_HIGH      "Alimentation active HIGH"
    #define STRING_FIL_RUNOUT             "Capteur de filament"
    #define STRING_FIL_RUNOUT_INVERTING   "Inversion logique capteur"
