...
#define _LANGUAGE_JP_H_
    ...
    #define JP_STEPS_SETTING            "Steps per MM"
    #define JP_MAXFEEDRATE              "Max Feed Rate"
    #define JP_MAXACCELERATION          "Max Acceleration"
    #define JP_ACCELERATION             "Acceleration"
    #define JP_PRINT_ACCELERATION       "Print Acceleration"
    #define JP_RETRACT_ACCELERATION     "Retract Acceleration"
    ...
    #define JP_UNIFIDE_MENU             "Unified menu (need reboot)"
